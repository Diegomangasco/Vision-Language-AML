...
def parse_arguments():
    ...
    parser.add_argument('--dom_gen', type=str, default='False')
    parser.add_argument('--clip_pretrained', type=str, default='True')
    parser.add_argument('--clip_epochs', type=int, default=5000)
